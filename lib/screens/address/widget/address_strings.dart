class AddressStrings {
  ...
  static String fFirstName = 'First Name';
  static String fLastName = 'Last Name';
  static String fEmail = 'Email';
  static String fPhone = 'Phone';
  static String fAddress1 = 'Address 1';
