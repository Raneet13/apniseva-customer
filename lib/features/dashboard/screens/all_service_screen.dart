import 'package:apniseva/features/dashboard/models/dash_model.dart';
...
import '../../../screens/service/screens/service_screen.dart';
import 'sub_category_view.dart';

class AllServiceScreen extends StatefulWidget {
  final List<CategoryDtl>? getData;
  const AllServiceScreen({Key? key, this.getData = const []}) : super(key: key);
                  ...
                  return InkWell(
                    onTap: () async {
                      ...
                      preferences.setString(
                          ApiStrings.catID, categoryData[index].catId!);
                    ...
                    child: Container(
                        ...
                        child: ListTile(
                          leading: Padding(
                            ...
                            child: Image.network(
                              '${ApiEndPoint.imageAPI}/${categoryData[index].catImg!}',
                              width: 60,
                              height: 80,
                            ),
                          ),
                          title: Text(
                            categoryData[index].catName!,
