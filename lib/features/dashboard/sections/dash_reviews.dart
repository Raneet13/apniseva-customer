//dash_reviews.dart
import 'package:apniseva/features/dashboard/presentation/widgets/dash_strings.dart';
...
class DashReviews extends StatelessWidget {
  ...
  const DashReviews({Key? key, this.getTestimonialDetail}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: getTestimonialDetail!.isEmpty
          ? const Text('Your are the first one to share views')
          : ListView.builder(
                          ...
                          Row(
                            ...
                            children: [
                              CircleAvatar(
                                radius: 15,
                                backgroundImage:
                                    NetworkImage(DashStrings.bannerImg),
                              ),
                              Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  Text(
                                    getTestimonial[index].createdDate!,
                                    style:
