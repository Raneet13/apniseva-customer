...
import 'package:apniseva/features/dashboard/models/subcategory_model.dart';
...
class SubCategoryController extends GetxController {
  ...
  Future<bool> getSubCat() async {
    try {
      ...
      String? catID = preferences.getString(StorageKeys.categoryId);
      String? cityID = preferences.getString(StorageKeys.cityId);

      // Check if user is guest
      bool isGuest = preferences.getBool('isGuest') ?? true;
      String? userID =
          isGuest ? null : preferences.getString(StorageKeys.userId);
      ...
      String subCatAPI = ApiEndpoints.subCategory;
      debugPrint(
