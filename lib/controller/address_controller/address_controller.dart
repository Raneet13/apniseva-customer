...
class AddressController extends GetxController {
  ...
  addAddress() async {
    ...
    try {
      ...
      http.Response response = await http.post(Uri.parse(addressAPI),
  ...
  updateAddress() async {
    ...
    try {
      ...
      http.Response response = await http.post(Uri.parse(updateAddressAPI),
      ...
      if (response.statusCode == 200) {
        ...
        Get.snackbar(
            'Updated Adress', updateAddressModel.value.messages!.status!,
            colorText: Colors.white);
        isLoading.value = false;
      }
      isLoading.value = false;
